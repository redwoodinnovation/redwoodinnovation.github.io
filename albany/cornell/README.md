...
- Streets, the school grounds polygon, and school building polygons are generated by an overpass api query and converted to geojson and stored locally. The query and conversion are called by a python script which is triggered by a GitHub Action cron schedule. In this examle, the cron schedule initiates the queries every 8 hours. 

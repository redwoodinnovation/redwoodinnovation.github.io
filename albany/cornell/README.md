...
- Note: Hidden in the current GitHub website: Electricity (kWh), natural gas (kBTU), and water (gal) are manually entered with the "Meter Reading Form" Google Form and are displayed as a circle node which changes size.
...
- Note: Hidden in the current GitHub website: The property line polygon is a geojson file stored in GitHub.

- Note: Hidden in the current GitHub website: Tree and entrance node data are from OSM and are stored in local csv files.
